...
mob keepInBounds(mob playr, mob lastPlayr, map world[WORLDROWS][WORLDCOLS])   // you can make this shit more clean...cmon man
{
	if (playr.row != lastPlayr.row && playr.col != lastPlayr.col)
	{
		if (world[playr.row][playr.col].walkable == false)
		{
			...
			else       //YOU CAN MAKE THIS SHIT CLEANER COME THE FUCK ON MAN
			{
...
//	if (cam.row + 1 == camDest.row || cam.row - 1 == camDest.col)
//	{
//		cam.row = camDest.row;
//	}
//	else
...
//	}
//	
//	if (cam.col + 1 == camDest.col || cam.col - 1 == camDest.col)
//	{
//		cam.col = camDest.col;
//	}
//	else
